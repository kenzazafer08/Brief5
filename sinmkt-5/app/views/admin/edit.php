...
<form style=" width: 90%;" action="<?php echo URLROOT .'/dashboard/edit/'.$data['id'] ?>" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="image" placeholder="Enter Image URL" value="<?php echo $data['image'] ?>">
    <span class="invalid-feedback"><?php echo $data['image_err'] ?></span>
  </div>
  <div class="form-group">
    <label for="disc">Discription</label>
    <input type="text" class="form-control" name="description" placeholder="Discription" value="<?php echo $data['description'] ?>">
